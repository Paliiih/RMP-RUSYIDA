...
<title>Kerja Sama — PT Rusyida Mitra Perkasa</title>
...
<section class="page-hero">
  <div class="page-hero-inner">
    <div class="breadcrumb"><a href="index.php">Beranda</a> / Kerja Sama</div>
    <h1>Outsourcing Tenaga Kerja Profesional</h1>
    <p>Kami spesialis outsourcing tenaga kerja, dengan opsi rekrutmen & penempatan sebagai layanan tambahan sesuai kebutuhan perusahaan Anda.</p>
  </div>
</section>
...
<section class="services">
  <div class="container">
    <div class="section-head">
      <div class="eyebrow">Layanan Utama</div>
      <h2>Outsourcing Tenaga Kerja Profesional</h2>
      <p>Fokus utama kami adalah menyediakan tenaga kerja lewat skema outsourcing, dengan opsi rekrutmen sebagai layanan tambahan sesuai kebutuhan Anda.</p>
    </div>
    <div class="scheme-grid">
      <div class="scheme-card featured">
        <span class="scheme-badge">Layanan Utama</span>
        <h3>Outsourcing Tenaga Kerja</h3>
        <p>Tenaga kerja (security, cleaning service, staff pabrik, dll) tetap menjadi karyawan kami dan ditempatkan di perusahaan Anda — solusi utama kami.</p>
        <ul>
          <li>Pengelolaan administrasi & payroll oleh kami</li>
          <li>Tenaga kerja siap kerja dan terlatih</li>
          <li>Laporan kinerja berkala</li>
        </ul>
        <a href="kontak.php" class="btn btn-primary" style="width:100%;justify-content:center;">Ajukan Skema Ini →</a>
      </div>
      <div class="scheme-card">
        <span class="scheme-badge" style="position:static;display:inline-block;margin-bottom:12px;background:var(--cream);color:var(--navy);border:1px solid var(--line);">Layanan Tambahan</span>
        <h3>Rekrutmen & Penempatan</h3>
        <p>Sebagai opsi tambahan, kami juga membantu mencari, menyeleksi, dan menyerahkan kandidat yang langsung menjadi karyawan perusahaan Anda.</p>
        <ul>
          <li>Proses seleksi ketat sesuai kualifikasi</li>
          <li>Akses ke jaringan kandidat luas</li>
          <li>Garansi penggantian kandidat</li>
        </ul>
        <a href="kontak.php" class="btn btn-outline" style="color:var(--navy);border-color:var(--navy);width:100%;justify-content:center;">Ajukan Skema Ini →</a>
      </div>
      <div class="scheme-card">
        <h3>Kombinasi Sesuai Kebutuhan</h3>
        <p>Gabungan skema outsourcing dan rekrutmen, disesuaikan dengan kebutuhan spesifik tiap divisi perusahaan.</p>
        <ul>
          <li>Fleksibel sesuai jenis posisi</li>
          <li>Kesepakatan sesuai kebutuhan</li>
          <li>Konsultasi skema tanpa biaya</li>
        </ul>
        <a href="kontak.php" class="btn btn-outline" style="color:var(--navy);border-color:var(--navy);width:100%;justify-content:center;">Ajukan Skema Ini →</a>
      </div>
    </div>
...
<section class="about">
  <div class="container about-wrap">
    <div class="about-text">
      <div class="eyebrow">Cara Bergabung</div>
      <h2>Proses Kerja Sama yang Sederhana</h2>
      <p><strong>1. Hubungi Kami</strong> — Sampaikan kebutuhan tenaga kerja dan skema yang diminati melalui kontak atau WhatsApp.</p>
      <p><strong>2. Diskusi Kebutuhan</strong> — Tim kami akan menjadwalkan sesi diskusi untuk memahami posisi dan jumlah tenaga kerja yang dibutuhkan.</p>
      <p><strong>3. Kesepakatan &amp; Penempatan</strong> — Penandatanganan kesepakatan dan proses seleksi/penempatan tenaga kerja dimulai.</p>
      <div class="about-cta">
        <a href="kontak.php" class="btn btn-outline" style="color:var(--navy);border-color:var(--navy);">Ajukan Kerja Sama Sekarang →</a>
      </div>
    </div>
    <div class="about-visual"><div class="mark"><img src="logo_2.jpeg" alt="PT Rusyida Mitra Perkasa"></div></div>
  </div>
</section>
<div class="cta-band">
