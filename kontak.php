...
<title>Kontak — PT Rusyida Mitra Perkasa</title>
...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  .email-float{
    ...
    display:flex;align-items:center;gap:10px;
    background:var(--navy);color:#fff;padding:14px 18px;border-radius:50px;
    box-shadow:0 10px 28px -8px rgba(15,42,61,.55);
    font-weight:600;font-size:14px;transition:.25s;
  }
  .email-float:hover{transform:translateY(-3px);background:var(--navy-deep);box-shadow:0 14px 32px -8px rgba(15,42,61,.65);}
  .email-float svg{width:22px;height:22px;flex-shrink:0;color:var(--gold-light);}
  .email-text{max-width:0;overflow:hidden;white-space:nowrap;transition:.3s;}
  .email-float:hover .email-text{max-width:160px;}
  ...
  .proj-thumb{aspect-ratio:16/9;background:linear-gradient(135deg,var(--navy) 0%,var(--navy-deep) 100%);position:relative;}
  .proj-tag{
  ...
  .contact-form a:hover{transform:translateY(-2px);box-shadow:0 8px 20px -6px rgba(0,0,0,.15);}
...
<section class="page-hero">
  <div class="page-hero-inner">
    ...
    <h1>Mari Diskusikan Kebutuhan Tenaga Kerja Anda</h1>
    <p>Tim kami siap merespon pertanyaan, konsultasi, maupun pengajuan kerja sama penyediaan tenaga kerja Anda dalam 1x24 jam.</p>
  </div>
</section>
  ...
  <div class="container contact-wrap">
    <div>
      <div class="contact-info-card">
        ...
        <div><h4>Alamat</h4><p>Kp. Sikunir Baru RT 03 RW 05, Kel. Plalangan, Kec. Gunungpati, Semarang</p></div>
      </div>
      <div class="contact-info-card">
        <div class="contact-icon">✉️</div>
        <div><h4>Email</h4><a href="mailto:rusyida.rmp@gmail.com">rusyida.rmp@gmail.com</a></div>
      </div>
      <div class="contact-info-card">
        <div class="contact-icon">💬</div>
        <div><h4>WhatsApp</h4><a href="https://wa.me/+62 813-2661-9901" onclick="return openWhatsApp(event,'+62 813-2661-9901')">+62 813-2661-9901</a></div>
      </div>
      <div class="contact-info-card">
        <div class="contact-icon">🕐</div>
        <div><h4>Jam Operasional</h4>
          <p>Senin 08.00 – 16.00 WIB</p>
          <p>Selasa 08.00 – 16.00 WIB</p>
          <p>Rabu 08.00 – 16.00 WIB</p>
          <p>Kamis 08.00 – 16.00 WIB</p>
          <p>Jum'at 08.00 – 14.00 WIB</p>
          <p>Sabtu 08.00 – 14.00 WIB</p>
        </div>
      </div>
      <div class="map-box">
        <iframe src="https://www.google.com/maps?q=Kp.+Sikunir+Baru,+Plalangan,+Gunungpati,+Semarang&output=embed" width="100%" height="100%" style="border:0;" loading="lazy"></iframe>
      </div>
    </div>
    ...
    <div class="contact-form">
      <div class="section-head" style="margin-bottom:26px;">
        ...
        <h2 style="font-size:24px;">Chat Langsung dengan Tim Kami</h2>
        <p>Pilih cara yang paling nyaman untuk Anda, tim kami siap merespon cepat.</p>
      </div>

      <div style="display:flex;flex-direction:column;gap:16px;">
        <a href="mailto:rusyida.rmp@gmail.com" style="display:flex;align-items:center;gap:18px;padding:22px;border:1px solid var(--line);border-radius:12px;text-decoration:none;transition:.2s;">
          <div style="width:48px;height:48px;flex-shrink:0;border-radius:50%;background:var(--navy);display:flex;align-items:center;justify-content:center;">
            <svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:24px;height:24px;"><path d="M4 4h16v16H4z"/><path d="m22 6-10 7L2 6"/></svg>
          </div>
          <div>
            <div style="font-weight:700;color:var(--navy);font-size:17px;">Kirim Email</div>
            <div style="color:var(--slate);font-size:14.5px;margin-top:2px;">rusyida.rmp@gmail.com</div>
          </div>
        </a>

        <a href="https://wa.me/+62 813-2661-9901" onclick="return openWhatsApp(event,'+62 813-2661-9901')" style="display:flex;align-items:center;gap:18px;padding:22px;border-radius:12px;text-decoration:none;background:#25D366;transition:.2s;">
          <div style="width:48px;height:48px;flex-shrink:0;border-radius:50%;background:#fff;display:flex;align-items:center;justify-content:center;">
            <svg viewBox="0 0 24 24" fill="#25D366" style="width:26px;height:26px;"><path d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.45 1.32 4.95L2.05 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21h.01c5.46 0 9.91-4.45 9.91-9.91 0-2.65-1.03-5.14-2.9-7.01A9.82 9.82 0 0012.04 2m0 1.67c2.2 0 4.26.86 5.82 2.42a8.19 8.19 0 012.41 5.83c0 4.55-3.7 8.24-8.24 8.24-1.48 0-2.93-.39-4.19-1.15l-.3-.17-3.12.82.83-3.04-.2-.32a8.2 8.2 0 01-1.26-4.38c0-4.55 3.7-8.25 8.25-8.25M8.53 7.33c-.16 0-.43.06-.66.31-.22.25-.86.84-.86 2.05 0 1.21.88 2.38 1 2.54.13.17 1.76 2.67 4.25 3.73.59.27 1.06.42 1.42.54.6.19 1.14.16 1.57.1.48-.07 1.46-.6 1.67-1.18.21-.58.21-1.07.14-1.18-.06-.1-.23-.16-.48-.29-.25-.12-1.47-.72-1.7-.81-.23-.08-.39-.12-.56.13-.16.25-.64.81-.78.97-.15.17-.29.18-.54.06-.25-.13-1.05-.39-2-1.23-.74-.66-1.24-1.47-1.39-1.72-.14-.25-.02-.38.11-.51.11-.11.25-.29.37-.43.12-.14.16-.25.24-.41.08-.17.04-.31-.02-.43-.06-.13-.56-1.36-.78-1.85-.2-.48-.41-.42-.56-.43-.14-.01-.31-.01-.47-.01z"/></svg>
          </div>
          <div>
            <div style="font-weight:700;color:#fff;font-size:17px;">Chat WhatsApp</div>
            <div style="color:#fff;font-size:14.5px;margin-top:2px;">+62 813-2661-9901</div>
          </div>
        </a>
      </div>
    </div>
    ...
    <div class="footer-grid">
      ...
      <div>
        ...
        <ul>
          ...
          <li><a href="mailto:rusyida.rmp@gmail.com">rusyida.rmp@gmail.com</a></li>
...
<a href="mailto:rusyida.rmp@gmail.com?subject=Konsultasi%20Kebutuhan%20Tenaga%20Kerja" class="email-float">
  ...
  <span class="email-text">Kirim Email</span>
</a>
