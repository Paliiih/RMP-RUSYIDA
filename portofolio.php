...
<title>Portofolio — PT Rusyida Mitra Perkasa</title>
...
<section class="page-hero">
  <div class="page-hero-inner">
    <div class="breadcrumb"><a href="index.php">Beranda</a> / Portofolio</div>
    <h1>Portofolio &amp; Rekam Jejak Kami</h1>
    <p>Sebagian penempatan dan kerja sama penyediaan tenaga kerja yang telah kami jalankan bersama klien.</p>
  </div>
</section>
...
<section class="services">
  <div class="container">
    <div class="proj-grid">
      <div class="proj-card">
        <div class="proj-thumb"><img src="porto_2.jpeg" alt="Kunjungan lapangan RMP"></div>
        <div class="proj-body"><h3>Kunjungan Direktur PT. Rusyida Mitra Perkasa</h3><p>ini bukan sekadar pertemuan, melainkan wujud komitmen untuk terus membangun hubungan profesional yang hangat dan saling percaya. Dari dialog yang terjalin, lahir ide, solusi, dan semangat baru untuk melangkah lebih maju bersama..</p></div>
      </div>
      <div class="proj-card">
        <div class="proj-thumb"><img src="porto_3.jpeg" alt="Rapat koordinasi RMP"></div>
        <div class="proj-body"><h3>Rapat Evaluasi dan Perencanaan Tahun 2026</h3><p>Merefleksikan pencapaian merencanakan kesuksesan.</p></div>
      </div>
      <div class="proj-card">
        <div class="proj-thumb"><img src="porto_1.jpeg" alt="Konsultasi klien RMP"></div>
        <div class="proj-body"><h3>Kunjungan klien oleh PT. Rusyida Mitra Perkasa.</h3><p> Merupakan bagian dari komitmen kami dalam membangun hubungan kerja sama yang kuat dan berkelanjutan. Melalui kunjungan ini, kami dapat berdiskusi secara langsung, memahami kebutuhan klien dengan lebih baik, serta memastikan setiap layanan yang kami berikan selalu tepat sasaran dan berkualitas.</p></div>
      </div>
      <div class="proj-card">
        <div class="proj-thumb"><img src="porto_4.jpeg" alt="Diskusi kerja sama RMP"></div>
        <div class="proj-body"><h3>Kunjungan Direktur ke klien Bank Mandiri Semarang</h3><p>Menjalankan proses rekrutmen massal bagi klien yang membutuhkan banyak tenaga kerja dalam waktu singkat.</p></div>
      </div>
    </div>
  </div>
</section>
...
<section class="portfolio">
  <div class="container">
    <div class="section-head">
      ...
      <h2>Apa Kata Klien &amp; Mitra Kami</h2>
    </div>
    <div class="testi-grid">
      <div class="testi-card">
        <p>"Tenaga security dan cleaning service yang ditempatkan sangat disiplin dan sesuai kebutuhan operasional kami."</p>
        <div class="testi-person"><div class="testi-avatar"></div><div><div class="pname">HRD Perusahaan Manufaktur</div><div class="prole">Klien Outsourcing</div></div></div>
      </div>
      <div class="testi-card">
        <p>"Proses rekrutmen cepat dan tenaga kerja yang diberikan sesuai dengan kualifikasi yang kami butuhkan."</p>
        <div class="testi-person"><div class="testi-avatar"></div><div><div class="pname">Perwakilan Mitra Usaha</div><div class="prole">Klien Rekrutmen</div></div></div>
      </div>
      <div class="testi-card">
        <p>"Tim RMP membantu kelancaran operasional kami dengan tenaga administrasi yang rapi dan terpercaya."</p>
        <div class="testi-person"><div class="testi-avatar"></div><div><div class="pname">Klien Korporat</div><div class="prole">Klien Outsourcing</div></div></div>
      </div>
    </div>
  </div>
</section>
...
<div class="cta-band">
  <h2>Jadi Bagian dari Cerita Sukses Berikutnya</h2>
  <p>Diskusikan kebutuhan tenaga kerja perusahaan Anda bersama tim kami.</p>
  <a href="kontak.php" class="btn btn-primary">Mulai Konsultasi →</a>
</div>
<div class="cta-band">
