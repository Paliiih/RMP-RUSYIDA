...
<title>Profil Perusahaan — PT Rusyida Mitra Perkasa</title>
...
<section class="page-hero">
  <div class="page-hero-inner">
    <div class="breadcrumb"><a href="index.php">Beranda</a> / Profil Perusahaan</div>
    <h1>Mengenal PT Rusyida Mitra Perkasa Lebih Dekat</h1>
    <p>Perusahaan penyedia jasa tenaga kerja profesional yang berdiri di atas nilai kepercayaan, profesionalisme, dan komitmen jangka panjang bagi setiap klien di Jawa Tengah.</p>
  </div>
</section>
...
<section class="about" style="padding-top:88px;">
  <div class="container about-wrap">
    ...
    <div class="about-text">
      <div class="eyebrow">Siapa Kami</div>
      <h2>Mitra Usaha yang Tumbuh Bersama Klien</h2>
      <p>PT. Rusyida Mitra Perkasa merupakan perusahaan yang bergerak di bidang penyediaan jasa tenaga kerja profesional pada 06 November 2013 berlokasi di Jl.Cangkiran-Gunungpati Semarang, dengan komitmen tinggi terhadap kualitas pelayanan dan ketepatan penempatan tenaga kerja. Kami hadir sebagai solusi strategis dan terintegrasi untuk kebutuhan sumber daya manusia di berbagai sektor industri dengan pendekatan yang efektif, efisien, dan kolaboratif.</p>
      <p>Berfokus pada layanan di bidang keamanan (security guard), kebersihan (cleaning service), serta operasional teknis seperti operator produksi, driver, dan IT support, kami memastikan setiap personel yang ditugaskan telah melalui proses seleksi dan pelatihan yang ketat.
Berlokasi di Semarang, kami melayani berbagai institusi mulai dari perusahaan swasta, instansi pemerintahan, hingga institusi pendidikan—dengan prinsip kemitraan jangka panjang yang berkelanjutan.</p>
      <p>Kami berkomitmen menjadi mitra terpercaya dengan menghadirkan tenaga kerja yang terlatih, berintegritas, dan siap kerja sesuai kebutuhan zaman.</p>
    </div>
  </div>
</section>
...
<section class="services">
  <div class="container">
    ...
    <div class="vm-grid">
      <div class="vm-card">
        <h3>Visi</h3>
        <p>Menjadi mitra terbaik dan paling terpercaya di bidang jasa dan pengolahan sumber daya manusia, dengan menghadirkan solusi layanan yang inovatif, berkelanjutan dan berdaya saing tinggi.</p>
      </div>
      <div class="vm-card mission">
        <h3>Misi</h3>
        <ul>
          <li>Membuka layanan kerja yang produktif dan berkelanjutan bagi masyarakat.</li>
          <li>Menyediakan solusi jasa tenaga kerja yang memberikan manfaat nyata bagi klien dan tenaga kerja.</li>
          <li>Membangun hubungan kerja yang saling menguntungkan, profesional, dan berbasis kepercayaan.</li>
        </ul>
      </div>
    </div>
  </div>
...
<section class="about" style="padding-top:0;">
  <div class="container">
    <div class="section-head">
      <div class="eyebrow">Nilai Kami</div>
      <h2>Prinsip yang Kami Pegang</h2>
      <p>Empat nilai inti yang menjadi landasan setiap layanan dan kemitraan yang kami jalankan.</p>
    </div>
    <div class="value-grid">
      <div class="value-card"><div class="vicon">01</div><h3>Kepercayaan</h3><p>Membangun hubungan jangka panjang dengan klien berlandaskan integritas dan transparansi.</p></div>
      <div class="value-card"><div class="vicon">02</div><h3>Profesionalisme</h3><p>Menempatkan tenaga kerja yang disiplin dan bekerja sesuai standar operasional.</p></div>
      <div class="value-card"><div class="vicon">03</div><h3>Ketepatan Seleksi</h3><p>Menjalankan proses rekrutmen yang teliti agar kandidat sesuai kebutuhan klien.</p></div>
      <div class="value-card"><div class="vicon">04</div><h3>Berorientasi Hasil</h3><p>Fokus pada solusi tenaga kerja yang berdampak nyata bagi operasional klien.</p></div>
    </div>
  </div>
</section>
...
<div class="cta-band">
  ...
  <p>Tim kami siap menjawab pertanyaan Anda dan mendiskusikan kebutuhan tenaga kerja Anda.</p>
